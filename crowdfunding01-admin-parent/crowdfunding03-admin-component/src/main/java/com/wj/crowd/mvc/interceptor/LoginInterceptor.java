package com.wj.crowd.mvc.interceptor;

import com.wj.crowd.constant.CrowdConstant;
import com.wj.crowd.entity.Admin;
import com.wj.crowd.exception.AccessForbiddenException;
...
public class LoginInterceptor extends HandlerInterceptorAdapter {
    ...
    public boolean preHandle(HttpServletRequest request, HttpServletResponse response,
        ...
        if(admin == null) {
            ...
            throw
                    new
                            AccessForbiddenException(CrowdConstant.MESSAGE_ACCESS_FORBIDDEN);
        }
